...
public void Postreq() {
    RestAssured.baseURI = "https://petstore.swagger.io/v2/pet";
    Response response=given().contentType(ContentType.JSON).body("{\"id\":111,\"category\":{\"id\":0,\"name\":\"Schmidt\"},\"name\":\"Polly\",\"photoUrls\":[\"string\"],\"tags\":[{\"id\":11111,\"name\":\"amitt\"}],\"status\":\"sold\"}\n" +
            "  ")  .when().post();
    ...
    public void findPetWithObjectMapper() throws IOException {
        ...
        Response response = request.get("/111");
        System.out.println("Raw JSON: " + response.asString());
        // ✅ Correct way to parse JSON response
        ObjectMapper mapper = new ObjectMapper();
        JsonNode jsonNode = mapper.readTree(response.asString());
        // Example: print pet name
        System.out.println("Pet Name: " + jsonNode.get("name").asText());
        System.out.println( jsonNode.get("category").get("id").asText());
        System.out.println(jsonNode.get("category").get("name").asText());
        System.out.println(jsonNode.get("tags").get(0).get("id").asText());
        System.out.println(jsonNode.get("tags").get(0).get("name").asText());
    }
//Raw JSON: {"id":111,"category":{"id":0,"name":"Schmidt"},"name":"Polly","photoUrls":["string"],"tags":[{"id":0,"name":"string"}],"status":"sold"}
//Pet Name: Polly
//0
//Schmidt
//0
...
//        }
    ...
    public void myURI() {
        ...
        System.out.println("resTime==="+resTime);//resTime===1082
    ...
    public void myURILogError() {
       //RestAssured.baseURI = "https://api.github.com/users/zellwk/repos";
        ...
        //Date: Sun, 12 Oct 2025 07:47:13 GMT
    }
}
